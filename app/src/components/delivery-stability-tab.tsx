    ...
    <div className="space-y-6">
      ...
      {data.length === 0 ? (
        ...
        <div className="grid grid-cols-1 gap-4 px-4 lg:grid-cols-2 lg:px-6">
          <MiniBar title="Feed Retention %" metric="feedRetention" data={data} />
          <MiniBar title="SLA Score %" metric="feedSlaScore" data={data} />
      ...
      <CardContent className="px-2 pb-4">
        <ChartContainer config={cfg} className="h-[180px] w-full">
          <BarChart data={data}>
            ...
            <Bar dataKey={metric} fill={CHART_COLORS[metric]} radius={[3, 3, 0, 0]} />
            {metric2 && <Bar dataKey={metric2} fill={CHART_COLORS[metric2]} radius={[3, 3, 0, 0]} />}
          </BarChart>
        </ChartContainer>
      </CardContent>
    </Card>
